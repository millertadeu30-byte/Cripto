      ...
      return (
        <div className="min-h-screen bg-[#181a20] text-white flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-[#1e2026] border border-gray-800 rounded-2xl p-6 text-center space-y-4 shadow-2xl">
            ...
            <h2 className="text-xl font-bold font-sans">Ajuste de Exibição do Navegador</h2>
            <p className="text-xs text-gray-400 leading-relaxed font-sans">
              Ocorreu uma pequena divergência de tradução automática ou renderização no seu navegador. Clique no botão abaixo para restaurar o painel instantaneamente.
            </p>
            <div className="pt-2">
              <button
                onClick={this.handleReset}
                className="w-full bg-[#f0b90b] hover:bg-[#d4a30a] text-black font-bold py-2.5 px-4 rounded-xl text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
